...
class LocationService {
  ...
  static Future<void> openGoogleMaps(String address) async {
    try {
      ...
      if (kDebugMode) debugPrint('❌ Erreur lors de l\'ouverture de Google Maps: $e');
      rethrow;
    }
  }
  ...
  static Future<void> openAppleMaps(String address) async {
    try {
      ...
      if (kDebugMode) debugPrint('❌ Erreur lors de l\'ouverture d\'Apple Maps: $e');
      rethrow;
    }
  }
    ...
    try {
      ...
      if (!kIsWeb) {
        try {
          ...
          if (kDebugMode) debugPrint('⚠️ Apple Maps non disponible, essai Google Maps...');
        }
      }
      ...
      if (kDebugMode) debugPrint('❌ Erreur lors de l\'ouverture de Maps: $e');
      rethrow;
    }
  }
